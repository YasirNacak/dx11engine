...
namespace s3d { namespace graphics {
	...
	bool Graphics::InitializeImGui(HWND hwnd)
	{
		...
		colors[ImGuiCol_TitleBg] = ImVec4(0.56f, 0.56f, 0.56f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.63f, 0.63f, 0.63f, 1.00f);
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.00f, 0.00f, 0.00f, 1.00f);
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.57f, 0.57f, 0.57f, 1.00f);
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.30f, 0.30f, 0.30f, 1.00f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.79f, 0.79f, 0.79f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.81f, 0.81f, 0.81f, 0.82f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.77f, 0.77f, 0.77f, 0.60f);
		colors[ImGuiCol_CheckMark] = ImVec4(0.90f, 0.90f, 0.90f, 0.50f);
		colors[ImGuiCol_SliderGrab] = ImVec4(1.00f, 1.00f, 1.00f, 0.30f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(0.78f, 0.78f, 0.78f, 0.60f);
		colors[ImGuiCol_Button] = ImVec4(0.62f, 0.62f, 0.62f, 0.62f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.70f, 0.70f, 0.70f, 0.79f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.80f, 0.80f, 0.80f, 1.00f);
		colors[ImGuiCol_Header] = ImVec4(0.89f, 0.89f, 0.89f, 0.45f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.88f, 0.88f, 0.88f, 0.80f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.85f, 0.85f, 0.86f, 0.80f);
		colors[ImGuiCol_Separator] = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.68f, 0.68f, 0.68f, 1.00f);
		...
		colors[ImGuiCol_NavHighlight] = ImVec4(0.93f, 0.93f, 0.93f, 0.80f);
